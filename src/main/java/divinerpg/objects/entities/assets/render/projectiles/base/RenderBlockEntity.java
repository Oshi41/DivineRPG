package divinerpg.objects.entities.assets.render.projectiles.base;
...
public class RenderBlockEntity<T extends Entity & IBlockRender> extends Render<T> {
    public RenderBlockEntity(RenderManager renderManagerIn) {
