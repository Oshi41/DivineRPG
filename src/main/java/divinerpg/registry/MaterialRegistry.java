...
public class MaterialRegistry {
    ...
    public static final ArmorMaterial HALITE_ARMOR = EnumHelper.addArmorMaterial("drpg_halite_armor", DivineRPG.MODID + ":halite", 42, new int[] {5, 7, 8, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F);
