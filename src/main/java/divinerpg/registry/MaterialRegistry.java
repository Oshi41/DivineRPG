...
public class MaterialRegistry {
    ...
    public static final ArmorMaterial AWAKENED_HALITE_ARMOR = EnumHelper.addArmorMaterial("drpg_awakened_halite_armor", DivineRPG.MODID + ":awakened_halite", 42, new int[] {5, 7, 8, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
