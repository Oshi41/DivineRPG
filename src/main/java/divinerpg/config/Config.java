...
public class Config {
    ...
    private static void initMobStats(Configuration cfg) {
        Map<ResourceLocation, MobStatInfo> defaultModStates = new LinkedHashMap<ResourceLocation, MobStatInfo>() {{
            ...
            put(new ResourceLocation(Reference.MODID, "advanced_cori"), new MobStatInfo(35.0, 60.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "apalachia_cadillion"), new MobStatInfo(90.0, 16.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "apalachia_golem"), new MobStatInfo(250.0, 19.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "apalachia_tomo"), new MobStatInfo(115.0, 14.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "basilisk"), new MobStatInfo(500.0, 10.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "behemoth"), new MobStatInfo(180.0, 14.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "cave_crawler"), new MobStatInfo(30.0, 7.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "caveclops"), new MobStatInfo(60.0, 8.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "cyclops"), new MobStatInfo(35.0, 8.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "demon_of_darkness"), new MobStatInfo(200.0, 21.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "densos"), new MobStatInfo(1000.0, 28.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "desert_crawler"), new MobStatInfo(40.0, 8.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "eden_cadillion"), new MobStatInfo(75.0, 12.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "eden_tomo"), new MobStatInfo(100.0, 10.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "enchanted_warrior"), new MobStatInfo(200.0, 20.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "enthralled_dramcryx"), new MobStatInfo(80.0, 14.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "greenfeet"), new MobStatInfo(200.0, 16.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "jungle_dramcryx"), new MobStatInfo(40.0, 9.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "miner"), new MobStatInfo(40.0, 7.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "pumpkin_spider"), new MobStatInfo(50.0, 9.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "rotatick"), new MobStatInfo(40.0, 8.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "saguaro_worm"), new MobStatInfo(80.0, 6.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "skythern_fiend"), new MobStatInfo(80.0, 22.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "skythern_golem"), new MobStatInfo(300.0, 20.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "soul_stealer"), new MobStatInfo(140.0, 25.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "sun_archer"), new MobStatInfo(60.0, 10.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "the_eye"), new MobStatInfo(40.0, 12.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "the_grue"), new MobStatInfo(30.0, 13.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "verek"), new MobStatInfo(50.0, 18.0, 0.0));
            ...
            put(new ResourceLocation(Reference.MODID, "wildwood_cadillion"), new MobStatInfo(85.0, 14.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "wildwood_golem"), new MobStatInfo(200.0, 18.0, 0.0));
            put(new ResourceLocation(Reference.MODID, "wildwood_tomo"), new MobStatInfo(110.0, 12.0, 0.0));
