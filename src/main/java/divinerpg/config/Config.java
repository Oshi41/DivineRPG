...
public class Config {
    ...
    private static void initMobStats(Configuration cfg) {
        Map<String, Float> attrubutesMap = new LinkedHashMap<String, Float>() {{
            ...
            put("advanced_cori_attack", 60.0F);
            ...
            put("apalachia_cadillion_attack", 16.0F);
            put("apalachia_cadillion_health", 90.0F);
            put("apalachia_golem_attack", 19.0F);
            put("apalachia_golem_health", 250.0F);
            put("apalachia_tomo_attack", 14.0F);
            ...
            put("demon_of_darkness_attack", 21.0F);
            ...
            put("skythern_fiend_attack", 22.0F);
            put("skythern_fiend_health", 80.0F);
            put("skythern_golem_attack", 20.0F);
            ...
            put("wildwood_cadillion_attack", 14.0F);
            put("wildwood_cadillion_health", 85.0F);
            put("wildwood_golem_attack", 18.0F);
            put("wildwood_golem_health", 200.0F);
            put("wildwood_tomo_attack", 12.0F);
